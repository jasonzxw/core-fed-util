 ...
 * @returns {string}
 */
export function getSpecificLocalDateTime(date: Date): string {
 ...
 * @returns {string}
 */
export function getSpecificLocalDate(date: Date): string {  
 ...
 * @returns {string}
 */
export function getSpecificTime(date: Date): string {
    const options = { hour: '2-digit', minute: '2-digit', second: '2-digit' };
    return date.toLocaleTimeString(undefined, options as any);
}
 ...
 * @returns {string}
 */
export function getFormatDate(date:Date, format:string = '-') {
 ...
 * @returns {string}
 */
export function getFormatTime(date:Date, format:string = ':') {
 ...
 * @returns {string}
 */
export function getSpecificDateTime(date:Date, formatDate:string = '-', formatTime:string = ':') {
 ...
 */
export function dateDiff(date1:Date, date2:Date, unit = 'day') {
