 ...
 */
export async function executeAsyncFunctionsInOrder(functions: Array<Function>): Promise<Array<AsyncResult>> {
    let results: Array<AsyncResult> = [];
 ...
 */
export async function executeAsyncFunctionsConcurrently(functions: Array<Function>): Promise<Array<any>> {
 ...
 * @returns {Array}
 */
export async function runWithConcurrencyInLimit(tasks:Array<Function>, maxConcurrency:number): Promise<Array<any>> {
 ...
 * @returns {Promise}
 */
async function asyncify(fn: Function): Promise<(...args: any[]) => Promise<any>> {
