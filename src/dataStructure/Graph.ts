...
export class Graph{
     ...
     */
    hasVertex(vertex:string|number) {
     ...
     */
    isConnected(vertex1:string|number, vertex2:string|number) {
     ...
     * @param {*} callback 
     */
    bfs(startVertex:string|number, callback: (vertex: string | number) => void) {
        const visited = {} as Record<string | number, boolean>;
     ...
     * @param {*} callback 
     */
    dfs(startVertex:string|number, callback: (vertex: string | number) => void) {
        const visited = {} as Record<string | number, boolean>;
