 ...
 */
export function getNthLargest(arr, n) {
    if (n > arr.length) {
        return null;
    }
 ...
 */
export function subtractFloat(num1, num2) {
    const decimalPlaces1 = getDecimalPlaces(num1);
    const decimalPlaces2 = getDecimalPlaces(num2);
    const maxDecimalPlaces = Math.max(decimalPlaces1, decimalPlaces2);
    const factor = Math.pow(10, maxDecimalPlaces);
 ...
 */
export function multiplyFloat(num1, num2) {
    const decimalPlaces1 = getDecimalPlaces(num1);
    const decimalPlaces2 = getDecimalPlaces(num2);
 ...
 */
export function divideFloat(num1, num2) {
    const decimalPlaces1 = getDecimalPlaces(num1);
    const decimalPlaces2 = getDecimalPlaces(num2);
    const totalDecimalPlaces = decimalPlaces1 - decimalPlaces2;
    return (num1 / num2) * Math.pow(10, totalDecimalPlaces);
 ...
 * @returns {number}
 */
export function convertNumberToDecimal(num) {
 ...
 * @returns {string}
 */
export function convertNumberBase(number, base = 10) {
 ...
 * @returns {string}
 */
export function padNumber(num, padNum, length = 2) {
